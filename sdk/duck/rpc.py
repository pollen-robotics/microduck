...
Taken from `spaces/shared/control.py` unchanged, because a fourth implementation of the same wire
is a fourth thing to keep in step. It is transport-agnostic already — three of them have been
carried on it — and `Duck` binds a WebSocket to it the way a Space binds a datachannel.
